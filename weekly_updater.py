# weekly_updater.py
# Fetch odds via The Odds API, join with internal 2025 game summary,
# compute simple model probabilities & EV, and save to data/games_model_2025.csv
